...
const ScoreDisplay = ({
  ...
  <div className="fixed bottom-6 left-6 z-1000 flex flex-col gap-2 lg:gap-4 pointer-events-none">
    <ContainerComponent>
      <div className="flex justify-center items-center gap-2 px-2 lg:px-4">
        ...
        <span className="text-lg lg:text-xl"> Wins: </span>
    ...
    <ContainerComponent>
      <div className="flex justify-center items-center gap-2 px-2 lg:px-4">
        ...
        <span className="text-lg lg:text-xl"> Fails: </span>
